...
use super::extractor::{AstExtractor, ExtractedAst};
use super::loop_analyzer::LoopAnalyzer;
use super::performance_optimizer::{AnalysisCache, IncrementalAnalyzer, OptimizedAnalyzer, PerformanceMetrics};
use super::scope_analyzer::ScopeAnalyzer;
use super::types::ScopeTree;
use anyhow::Result;
