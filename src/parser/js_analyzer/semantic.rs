...
pub struct SemanticAnalyzer {
    /// 已识别的框架列表
    frameworks: Vec<FrameworkSignature>,
...
impl SemanticAnalyzer {
    ...
    pub fn new() -> Self {
        Self {
            frameworks: Self::create_framework_signatures(),
    ...
    pub fn analyze_with_enhanced_ast(
        ...
        enhanced: &crate::parser::js_analyzer::EnhancedAst,
    ...
    fn create_framework_signatures() -> Vec<FrameworkSignature> {
        vec![
            FrameworkSignature {
                name: "React",
                keywords: vec!["React", "Component", "useState", "useEffect", "jsx"],
                patterns: vec!["React.createElement", "ReactDOM.render"],
            },
            FrameworkSignature {
                name: "Vue",
                keywords: vec!["Vue", "Vuex", "computed", "watch"],
                patterns: vec!["Vue.extend", "new Vue", "v-if", "v-for"],
            },
            FrameworkSignature {
                name: "Angular",
                keywords: vec!["Angular", "Component", "Service", "Module"],
                patterns: vec!["@Component", "@Injectable", "ngIf"],
            },
            FrameworkSignature {
                name: "jQuery",
                keywords: vec!["jQuery", "$"],
                patterns: vec!["$.ajax", "$(", "jQuery("],
            },
        ]
    }
    ...
    fn create_event_patterns() -> Vec<EventPattern> {
        vec![
            EventPattern {
                event_type: "click",
                pattern: r#"addEventListener\s*\(\s*["']click["']"#,
            },
            EventPattern {
                event_type: "change",
                pattern: r#"addEventListener\s*\(\s*["']change["']"#,
            },
            EventPattern {
                event_type: "submit",
                pattern: r#"addEventListener\s*\(\s*["']submit["']"#,
            },
            EventPattern {
                event_type: "load",
                pattern: r#"addEventListener\s*\(\s*["']load["']"#,
            },
        ]
    }
}
