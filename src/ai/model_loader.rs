...
impl ModelLoader {
    ...
    pub fn is_model_modified(&self, model_id: &str) -> Result<bool, String> {
        ...
        let model_meta = models.get(model_id)
    ...
    pub fn reload_model(&self, model_id: &str) -> Result<(), String> {
        ...
        let model_meta = models.get_mut(model_id)
            .ok_or_else(|| format!("Model not registered: {}", model_id))?;
        ...
        model_meta.last_modified = current_metadata.modified()
            .map_err(|e| format!("Failed to get modification time: {}", e))?;
...
mod tests {
    ...
    fn test_model_modification_check() {
        ...
        let loader = ModelLoader::new(temp_dir.path(), false);
        loader.register_model("test_model", "test_model.onnx", "test").unwrap();
    ...
    fn test_get_model_metadata() {
        ...
        let loader = ModelLoader::new(temp_dir.path(), false);
        loader.register_model("test_model", "test_model.onnx", "html_parser").unwrap();
