...
impl StyleTransformer {
    ...
    fn to_dark_theme(&self, original: &StyleSystem) -> StyleSystem {
        ...
        if original.colors.background_colors.is_empty() && original.colors.text_colors.is_empty() {
            ...
            new.colors.background_colors = vec![
                ...
                Color {
                    raw: "#16213e".to_string(),
                    hex: "#16213e".to_string(),
                    rgb: (22, 33, 62),
                    alpha: 1.0,
                    usage_count: 1,
                    usage_context: vec!["background".to_string()],
                ...
                Color {
                    raw: "#0f3460".to_string(),
                    hex: "#0f3460".to_string(),
                    rgb: (15, 52, 96),
                    alpha: 1.0,
                    usage_count: 1,
                    usage_context: vec!["background".to_string()],
            ...
            new.colors.text_colors = vec![
                Color {
                    raw: "#eaeaea".to_string(),
                    hex: "#eaeaea".to_string(),
                    rgb: (234, 234, 234),
                    alpha: 1.0,
                    usage_count: 1,
                ...
                Color {
                    raw: "#a0a0a0".to_string(),
                    hex: "#a0a0a0".to_string(),
                    rgb: (160, 160, 160),
                    alpha: 1.0,
                    usage_count: 1,
                    usage_context: vec!["text".to_string()],
            ...
            new.colors.primary_colors = vec![Color {
                raw: "#e94560".to_string(),
                hex: "#e94560".to_string(),
                rgb: (233, 69, 96),
                alpha: 1.0,
                usage_count: 1,
            ...
            if !original.colors.text_colors.is_empty() {
                new.colors.background_colors = original
                    .colors
                    .text_colors
                    .iter()
            ...
            if !original.colors.background_colors.is_empty() {
                new.colors.text_colors = original
                    .colors
                    .background_colors
                    .iter()
            ...
            if !original.colors.primary_colors.is_empty() {
                new.colors.primary_colors = original
                    .colors
                    .primary_colors
                    .iter()
    ...
    fn to_warm_tone(&self, original: &StyleSystem) -> StyleSystem {
        ...
        new.colors.primary_colors = vec![
            Color {
                raw: "#e74c3c".to_string(),
                hex: "#e74c3c".to_string(),
                rgb: (231, 76, 60),
                alpha: 1.0,
                usage_count: 1,
                usage_context: vec!["primary".to_string()],
            ...
            Color {
                raw: "#f39c12".to_string(),
                hex: "#f39c12".to_string(),
                rgb: (243, 156, 18),
                alpha: 1.0,
                usage_count: 1,
            ...
            Color {
                raw: "#d35400".to_string(),
                hex: "#d35400".to_string(),
                rgb: (211, 84, 0),
                alpha: 1.0,
                usage_count: 1,
        ...
        new.colors.background_colors = vec![
            Color {
                raw: "#fff5f0".to_string(),
                hex: "#fff5f0".to_string(),
                rgb: (255, 245, 240),
                alpha: 1.0,
                usage_count: 1,
                usage_context: vec!["background".to_string()],
            ...
            Color {
                raw: "#ffecd2".to_string(),
                hex: "#ffecd2".to_string(),
                rgb: (255, 236, 210),
                alpha: 1.0,
                usage_count: 1,
                usage_context: vec!["background".to_string()],
        ...
        new.colors.text_colors = vec![
            Color {
                raw: "#5d4037".to_string(),
                hex: "#5d4037".to_string(),
                rgb: (93, 64, 55),
                alpha: 1.0,
                usage_count: 1,
                usage_context: vec!["text".to_string()],
            ...
            Color {
                raw: "#8d6e63".to_string(),
                hex: "#8d6e63".to_string(),
                rgb: (141, 110, 99),
                alpha: 1.0,
                usage_count: 1,
                usage_context: vec!["text".to_string()],
    ...
    fn to_cool_tone(&self, original: &StyleSystem) -> StyleSystem {
        ...
        new.colors.background_colors = vec![
            ...
            Color {
                raw: "#e8f6f3".to_string(),
                hex: "#e8f6f3".to_string(),
                rgb: (232, 246, 243),
                alpha: 1.0,
                usage_count: 1,
                usage_context: vec!["background".to_string()],
        ...
        new.colors.text_colors = vec![
            ...
            Color {
                raw: "#34495e".to_string(),
                hex: "#34495e".to_string(),
                rgb: (52, 73, 94),
                alpha: 1.0,
                usage_count: 1,
                usage_context: vec!["text".to_string()],
    ...
    fn to_minimal(&self, original: &StyleSystem) -> StyleSystem {
        ...
        // 简化字体
        new.typography.font_families = vec![FontFamily {
    ...
    fn enhance_contrast(&self, color: &Color) -> Color {
        ...
        let new_rgb = (
            if color.rgb.0 as f32 > avg {
                ((color.rgb.0 as f32 + 30.0).min(255.0)) as u8
            } else {
                (color.rgb.0 as f32 - 30.0).max(0.0) as u8
            },
            if color.rgb.1 as f32 > avg {
                ((color.rgb.1 as f32 + 30.0).min(255.0)) as u8
            } else {
                (color.rgb.1 as f32 - 30.0).max(0.0) as u8
            },
            if color.rgb.2 as f32 > avg {
                ((color.rgb.2 as f32 + 30.0).min(255.0)) as u8
            } else {
                (color.rgb.2 as f32 - 30.0).max(0.0) as u8
            },
        );
        let new_hex = self.rgb_to_hex(new_rgb);
        Color {
